...
void setup() {
 // writeStringToEEPROM(10, "S01107");    //Use ones to program te serial number in the eeprom of the device
 // writeStringToEEPROM(20, "HW3");    //Use ones to program the hardware version in the eeprom of the device
